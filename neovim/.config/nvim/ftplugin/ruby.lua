...
buffer_map(0, 'n', '<leader>rr', ":lua _G.tests.rspec_run_nearest()<CR>", { noremap = true, desc = 'nearest test' })
buffer_map(0, 'n', '<leader>rf', ":lua _G.tests.rspec_run_file()<CR>", { noremap = true, desc = 'current file' })
buffer_map(0, 'n', '<leader>rl', ":lua _G.tests.run_last()<CR>", { noremap = true, desc = 'last test' })
buffer_map(0, 'n', '<leader>ra', ':lua _G.tests.rspec_run_all()<CR>', { noremap = true, desc = 'all files' })
