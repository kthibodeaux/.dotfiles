...
if ENV['BLOCK_BUTTON'].to_i == 1
  `firefox https://github.com/BaldwinAviation/baldwin-web/pulls?q=is%3Aopen+is%3Apr+label%3A%22Awaiting+Response%22%2C%22Changes+Requested%22+author%3Akthibodeaux+`
end
